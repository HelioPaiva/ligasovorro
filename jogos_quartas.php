...
<div class="container">
    <div class="row" id="linha">
      <div class="table-responsive">          
          ...
          <?php if($contador == 1){?>
            <tr>
                <td colspan="5" id="rodada"><a name="<?php echo $jogo['rodada']; ?>"></a><p><?php //echo $jogo['rodada'].'º '; ?>Quartas de Final</p></td>
          ...
          <?php };?>
            <tr>
              ...
              -->
              <td id="time">
		<img class="img-responsive" src="<?php echo $jogo['escudo_casa']; ?>" id="img"><?php echo utf8_encode($jogo['tela_casa']); ?>
	     </td>
              ...
              <?php }?>
              <td id="time">
			<img class="img-responsive" src="<?php echo $jogo['escudo_visitante']; ?>" id="img"><?php echo utf8_encode($jogo['tela_visitante']); ?>
	      </td>
