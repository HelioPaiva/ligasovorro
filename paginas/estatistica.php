      ...
      <div class="table-responsive">          
          ...
          <?php foreach ($cadastros as $cadastro) : ?>
            <tr>
              ...
              <td id="time"><img class="img-responsive" src="https://s.glbimg.com/es/sde/f/2016/05/01/4ca75c7b4c6ef9d48c9ffe43f89b8f78_140x140.png" id="img"></br><?php echo utf8_encode(strtolower($cadastro['timeTela'])); ?></td>
              ...
              <td id="aproveitamento"><?php if($cadastro['pontos'] == 0){echo '0%';}else{echo (($pontosTotal / $cadastro['pontos']) * 100).'%';}?></td>
