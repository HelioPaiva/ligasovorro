...
<div class="container">
    <div class="row">
        <div class="form-group col-md-2">
            <select name="rodada" id="idRodada" class="form-control" required="" onchange="window.location=this.value">
    ...
    <div class="row" id="linha">
      <div class="table-responsive">          
          ...
          <?php if($contador == 1){?>
            <tr>
                <td colspan="4" id="rodada"><a name="<?php echo $jogo['rodada']; ?>"></a><p><?php echo $jogo['rodada'].'º '; ?>Rodada</p></td>
                <td id="rodada"><a href="#top"><p>Voltar</p></a></td>
            </tr> 
          <?php };?>
            <tr>
              ...
              -->
              <td id="time"><img class="img-responsive" src="<?php echo $jogo['escudo_casa']; ?>" id="img"><?php echo utf8_encode($jogo['time_casa']); ?></td>
              ...
              <?php }?>
              <td id="time"><img class="img-responsive" src="<?php echo $jogo['escudo_visitante']; ?>" id="img"><?php echo utf8_encode($jogo['time_visitante']); ?></td>
